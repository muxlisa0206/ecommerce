...
let lastSixProducts = products.slice(products.length-12, products.length-6)

lastSixProducts.map((el) => {
    moreProducts.innerHTML += `
        <a href="../pages/product.html?id=${el.id}"  
            class="moreProducts max-w-[365px] w-full h-full rounded-[4px] bg-[#FFFFFF] shadow-[1px_2px_4px_0px_#0000001A;] p-[10px] grid grid-col-2 md:grid-col-3 lg:grid-col-4 hover:shadow-[4px_8px_16px_0px_#FF663333] duration-300">
                        <div class="relative">
